...
- Name: happy-path.gwt.spec.ts >> Happy Path GWT (QA-REQ: 001..031) >> E2E-007 departure statuses and completion action
- Location: e2e\happy-path.gwt.spec.ts:470:3
            ...
            - generic:
              - banner:
                - button:
                  ...
                  - img
                - generic:
                  - heading [level=1]: DEP-CMOU731K
                  - generic:
                    - generic:
                      - button:
                        - text: Открыть завершение
                        - img
                    - generic:
                ...
                - generic:
                  - button: APP-000224
                  - text: ·
                  - button: E2E 007 007-1778080270577-546
                  - text: · E2E 007-item
                - generic:
                  - generic:
                    - generic: Завершен
              ...
              - generic:
                - img
                - generic: "Следующий шаг: Открыть завершение"
              - generic:
                - generic:
                    ...
                    - generic:
                      - generic:
                        - generic:
                          - img
                        - generic: Адрес
                      - generic: Москва, Тестовая улица, 74
                    - generic:
                      - generic:
                        - generic:
                          - img
                        - generic: План дата
                      - generic: 2026-05-07T15:11:10.686Z
                    - generic:
                      - generic:
                        - generic:
                          - img
                      ...
                      - generic:
                        - generic:
                          - generic:
                            ...
                            - generic: Завершен
                            - generic: Выезд уже закрыт. Итог доступен в связанной карточке завершения.
                      - generic:
                        - generic:
                          - generic:
                          ...
                          - button:
                            - img
                            - text: Открыть
                        - generic: "Завершение уже создано: успешно · 06.05.2026, 20:11"
              - generic:
                - button:
                  - generic:
                    - img
        ...
        - generic [ref=e46]:
          - banner [ref=e47]:
            - button "Завершение" [ref=e48]:
              ...
              - img [ref=e53]
            - generic [ref=e55]:
              - heading "CMP-CMOU733J" [level=1] [ref=e56]
              - button "Открыть выезд" [ref=e59]:
                - img
                - text: Открыть выезд
            - generic [ref=e60]:
              - button "DEP-CMOU731K" [ref=e61]
              - text: ·
              - button "APP-000224" [ref=e62]
              - text: ·
              - button "E2E 007 007-1778080270577-546" [ref=e63]
            - generic [ref=e64]:
              - generic [ref=e66]:
                - img [ref=e67]
            ...
            - generic [ref=e84]:
              - generic [ref=e85]:
                ...
                - generic [ref=e110]:
                  ...
                  - generic [ref=e117]: E2E 007-item
              - textbox "Комментарий по завершению" [ref=e118]
          ...
          - generic [ref=e121]:
            ...
            - generic [ref=e125]:
              ...
              - generic [ref=e134]:
                ...
                - generic [ref=e141]: Москва, Тестовая улица, 74
              - generic [ref=e142]:
                - generic [ref=e143]:
                  - img [ref=e145]
                  - generic [ref=e149]: Клиент
                - button "E2E 007 007-1778080270577-546" [ref=e151]
              - generic [ref=e152]:
                - generic [ref=e153]:
                  - img [ref=e155]
          ...
          - generic [ref=e188]:
            - generic [ref=e189]:
              - img [ref=e190]
              - generic [ref=e193]: Повторный заказ
            - generic [ref=e194]: Заказ клиента закрыт — можно сразу создать новый лид по шаблону прошлого заказа.
            - generic [ref=e195]:
              - button "Создать повторный заказ" [ref=e196]:
                - img
                - text: Создать повторный заказ
              - button "Карточка клиента" [ref=e197]:
                - img
                - text: Карточка клиента
        - complementary [ref=e198]:
          - generic [ref=e199]:
            - button "Сводка" [ref=e201]:
              - img [ref=e202]
              - generic [ref=e204]: Сводка
            - generic [ref=e205]:
              - generic [ref=e206]:
                - generic [ref=e207]: Статус
                - generic [ref=e209]: Завершен
              - generic [ref=e210]:
                - generic [ref=e211]: Дата
                - generic [ref=e212]: 06.05.2026, 20:11
              - generic [ref=e213]:
                - generic [ref=e214]: Менеджер
                - generic [ref=e215]: Manager User
          - generic [ref=e216]:
            - button "Связанные записи" [ref=e218]:
              - img [ref=e219]
              - generic [ref=e221]: Связанные записи
            - generic [ref=e222]:
              - generic [ref=e223]:
                - generic [ref=e224]: Лид
                - button "LEAD-CMOU731F" [ref=e226] [cursor=pointer]
              - generic [ref=e227]:
                - generic [ref=e228]: Заявка
                - button "APP-000224" [ref=e230] [cursor=pointer]
              - generic [ref=e231]:
                - generic [ref=e232]: Бронь
                - button "RSV-CMOU731J" [ref=e234] [cursor=pointer]
              - generic [ref=e235]:
                - generic [ref=e236]: Выезд
                - button "DEP-CMOU731K" [ref=e238] [cursor=pointer]
              - generic [ref=e239]:
                - generic [ref=e240]: Завершение
                - button "CMP-CMOU733J" [ref=e242] [cursor=pointer]
              - generic [ref=e243]:
                - generic [ref=e244]: Клиент
                - button "E2E 007 007-1778080270577-546" [ref=e246] [cursor=pointer]
          - button "Быстрые действия" [ref=e249]:
            - img [ref=e250]
            - generic [ref=e252]: Быстрые действия
```
