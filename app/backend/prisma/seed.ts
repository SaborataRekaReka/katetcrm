    ...
    sections: [
      {
        id: 'general',
        title: 'Общие',
        description: 'Настройки демо-стенда для комбинаторного seed',
        rows: [
          { label: 'Название пространства', value: 'Katet CRM Demo Matrix' },
      ...
      },
      {
        id: 'seed',
        title: 'Сид',
        description: 'Покрытие статусов сущностей',
        rows: [
          { label: 'Leads', value: 'Все стадии PipelineStage' },
          { label: 'Reservations', value: 'Все ReservationInternalStage' },
          { label: 'Departures', value: 'Все DepartureStatus' },
          { label: 'Completions', value: 'completed + unqualified' },
          { label: 'Tasks', value: 'Все TaskStatus + TaskPriority' },
        ],
      },
    ],
  };
